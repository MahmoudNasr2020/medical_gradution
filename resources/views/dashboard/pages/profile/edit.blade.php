            ...
            <div class=" d-flex row m-0">
                <div class="col-12 col-lg-6 my-2" style="width: 100%;">
                    <form id="validate-form" class="row" method="POST"
                          action="{{route('dashboard.profile.update',['id'=>\Illuminate\Support\Facades\Auth::guard('admin')->user()->id])}}"
                        ...
                        <div class="col-12 col-lg-12 p-0 main-box">
                                ...
                                <div class="col-12 col-lg-12 p-2">
                                    ...
                                    <div class="col-12 pt-3">
                                        <input type="text" name="name" required  class="form-control"
                                               value="{{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->name }}" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 p-3 row">
                                <div class="col-12 col-lg-12 p-2">
                                    ...
                                    <div class="col-12 pt-3">
                                        <img src="{{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->image }}" style="width: 200px; height: 200px;">
                                    </div>
                                </div>
                            </div>
