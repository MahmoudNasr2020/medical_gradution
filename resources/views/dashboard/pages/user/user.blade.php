                            ...
                            @foreach($users as $k=>$user)
                                <tr>
                                    ...
                                    <td style="width: 180px;text-align: center">
                                        ...
                                        <a href="{{ route('dashboard.user.orders',$user->id) }}">
                                            <span class="btn  btn-outline-success btn-sm font-1 mx-1">
                                                <span class="fas fa-folders "></span> الطلبات
                                            </span>
                                        </a>
                                        <br>
                                        <br>
                                        ...
                                        <form method="POST" action="{{ route('dashboard.user.destroy',$user->id) }}" class="d-inline-block">
                                            @csrf
                                            @method("DELETE")
