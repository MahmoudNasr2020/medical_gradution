...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('site/assets/plugins/print.min.css') }}">
               ...
               <div class="card">
                   ...
                   <div class="card-body">
                       ...
                       <div class="container">
                           ...
                           <div class="row mx-3">
                               <div class="col-12">
                               اسم العميل :   <span style="font-weight: bold"> {{ \Illuminate\Support\Facades\Auth::user()->name }} </span>
                               </div>
                               <div class="col-12">
                                   رقم الهاتف :   <span style="font-weight: bold">{{ \Illuminate\Support\Facades\Auth::user()->phone_number }} </span>
                               </div>
                               <div class="col-12">
                                   العنوان :   <span style="font-weight: bold">{{ \Illuminate\Support\Facades\Auth::user()->address }} </span>
                               </div>
