                ...
                <div class="col-lg-12 col-md-12">
                    <div class="drodo-grid-sorting row align-items-center">
                        <div class="col-lg-6 col-md-6 result-count">
                            <p> وجدنا <span class="count">{{ $data->count() }}</span> منتج مرتبط بهذا البحث </p>

                            <span class="sub-title d-lg-none"><a href="#" data-bs-toggle="modal" data-bs-target="#productsFilterModal"><i class='bx bx-filter-alt'></i> فلترة</a></span>
                        </div>
                    </div>
